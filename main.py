...
def main(s):
    ...
    c.init_pair(BK_CUR,c.COLOR_BLUE,c.COLOR_WHITE)
    c.init_pair(ATTENTION,c.COLOR_RED,c.COLOR_BLUE)
    c.init_pair(ATTENTION_INACTIVE,c.COLOR_RED,c.COLOR_BLACK)
    c.init_pair(SEL_LINE,c.COLOR_YELLOW,c.COLOR_BLUE)
    c.init_pair(BK_CUR_SEL,c.COLOR_YELLOW,c.COLOR_WHITE)
    c.init_pair(BK_SEL,c.COLOR_YELLOW,c.COLOR_BLUE)
    c.init_pair(BUILDING_HEADER,c.COLOR_YELLOW,c.COLOR_BLACK)
    c.init_pair(KEY,c.COLOR_YELLOW,c.COLOR_BLACK)
    c.init_pair(TEST_OK,c.COLOR_GREEN,c.COLOR_BLUE)
    c.init_pair(TEST_FAIL,c.COLOR_RED,c.COLOR_BLUE)
